...
<div class = "container">
    <div class="wrapper">
        <form action="/controller" method="post" name="login_form" class="form-signin">
            ...
            <input type="text" class="form-control" name="email" placeholder=<fmt:message key="login.email"/> title=<fmt:message key="login.pattern"/> />
