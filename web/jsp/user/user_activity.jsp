        ...
        <div class="tab-content">
            <div class="tab-pane fade in active">
                ...
                <c:forEach var="feedback" items="${showAnotherUser? anotherUser.userFeedbacks : signedUser.userFeedbacks}">
                    <hr color="black">
                    <p><strong><a href="${pageContext.request.contextPath}/controller?command=get_movie_page&id_movie=${feedback.movie.id}" style="font-size: 16px;color: black">${feedback.movie.title}</a></strong></p>
